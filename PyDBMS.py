...
hostname = input("PLEASE ENTER YOUR HOSTNAME (By default: localhost):" ) or "localhost"     #no actuall need to enter you username and passwd if you have default ones
...
def table_creator():
    ...
    print("Kindly first create the initiating column for table, you would be given choice to create table with as much columns you want...")

    a = input("NAME FOR COLUMN 1:")
    t = input("DATATYPE OF COLUMN 1:")
    size = input("SIZE OF COLUMN 1:")

    choice = input("Do you want to add constrain to this column? y or n")
    ...
    x = int(input("PLEASE ENTER THE NUMBER OF COLUMNS YOU WANT IN TABLE:"))          #determing the degree of table
    i = 1 
...
def inputer():
    ...
    if table_name != "no_input":
        ...
        choice2 = int(input("ENTER THE NUMBER OF RECORDS YOU WANT TO ENTER:"))    #determining the number of records to be entered 
        a = 0
...
def print_table():
    ...
    if table_name != "no_input":
        ...
        if choice == 'a':
            ...
            choice1 = input("WOULD YOU LIKE TO SEE THE WHOLE TABLE ONCE FOR SPECIFYING THE CONDITION? \n \n for yes enter y \n \n for no enter n -->")

            if choice1 == 'y':     
                print("THE TABLE--")                                    #asking if user wants to see the table structure
