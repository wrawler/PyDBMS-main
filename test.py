...
def table_creator():
    try:
        ...
        choice1 = input("DO YOU WANT TO ADD CONSTRAINS TO THIS COLUMN ? y or n")    #asking if contrains are to be added
        ...
        while i < x:                                                  #loop to add columns to table
            ...
            if choice1 == "y":
                constrain = input("ENTER THE DESIRED CONSTRAINS SEPERATED BY SPACES:")              #two different conditions for having or not having constrains 
